"""
Zero-shot Inference for InternVL/Vintern Base Models
Tags: REASONING + CONCLUSION + EXPLANATION (same as GRPO for comparison)
"""
...
def infer(model: InternVLModel, question: str, image_path: str) -> dict:
    """Run zero-shot inference with GRPO prompt."""
...
def main():
    ...
    for item in tqdm(data, desc="Zero-shot Inference"):
