"""
SFT Baseline Inference for InternVL/Vintern
...
from ..common import get_sft_prompt, parse_sft_output, process_inference_sample
...
def infer(model: InternVLModel, question: str, image_path: str) -> dict:
    ...
    prompt = get_sft_prompt(question)
    ...
    return parse_sft_output(response)
...
def main():
    ...
    print("=" * 80)
    print("SFT Baseline Inference (CONCLUSION + EXPLANATION)")
    print("=" * 80)
    ...
    for item in tqdm(data, desc="SFT Inference"):
